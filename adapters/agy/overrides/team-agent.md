# team-agent 오버라이드 — Antigravity (agy) (테스터)

Antigravity(agy)는 팀에서 **테스터** 역할을 담당한다.
역할 터미널 타이틀: `tester` (tmux pane / Orca 탭). 확인: `bash .ai/core/skills/team-agent/scripts/whoami.sh`
